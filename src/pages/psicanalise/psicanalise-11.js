...
function Psicanlise_11 (){
    return (
        ...
        <Principal>
            ...
            <ol>
                <li>negação, quando a pessoa não se permite aceitar a existência do problema;</li>
                <li>raiva, marcada por revolta e inconformismo diante da situação de perda; </li>
                <li>barganha, quando o enlutado cria uma ficção de que a perda é algo que se pode reverter; </li>
                <li>depressão, marcada pela conscientização, seguida de profunda tristeza e melancolia;  </li>
                <li>aceitação, que é quando a nova realidade é finalmente aceita e a pessoa entende que a superação da situação é necessária e que lhe fará bem. </li>
            </ol>
            <p>Passado o período de dor mais aguda, embora ainda possa permanecer a marca do acontecimento, é comum que as pessoas recuperem a capacidade de tentar novamente, uma vez que a elaboração torna possível a retomada das boas lembranças do objeto amado que foram preservadas na memória. Dessa forma, os aspectos bons que foram preservados são tranquilamente revividos, contribuindo para a aceitação da perda. Em casos em que o indivíduo não consiga trilhar esse caminho sozinho é muito importante que ele procure  ajuda profissional para que possa ser devidamente orientado e acompanhado nessa importante travessia.</p>
        </Principal>
        <Footer/>
        </>
    )
}
export default Psicanlise_11