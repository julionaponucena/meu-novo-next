...
function Filosofia_06 (){
    return(
        ...
        <Principal>
            ...
            <p>Se você deseja fazer uma autoanálise a respeito do assunto, sugiro que comece por entender a diferença ente cultivar a esperança e a mera expectativa passiva de que aconteça aquilo que deseja. A esperança a que me refiro é dotada de comprometimento por parte do indivíduo diante das mudanças que ele deseja ver materializadas, exigindo por parte dele um esforço que o mobilize a dar vida àquilo que quer para si, acreditando na possibilidade de realização. Nessa perspectiva a esperança pressupõe um exercício de fé, de convicção na possibilidade de realização, mesmo que aparentemente a situação verificada no presente sugira outro resultado. Em situações em que as coisas não estejam  acontecendo da forma como gostaríamos, temos duas alternativas: a primeira é dar ouvidos à desesperança e adotar medidas de destempero, metendo os pés pelas mãos, desistindo de buscar alternativas, submetendo-se àquilo que parece ser o nosso destino. A segunda alternativa passa pela adoção de uma atitude mental positiva, com o intuito de elevar nosso nível de esforço visando encontrar caminhos que nos levem à superação e ao alcance dos nossos objetivos. Essa atitude nos permite assumir o controle da situação, mesmo diante de condições adversas, nos permitindo inclusive, agir com a sabedoria que nos permite mudar o direcionamento das nossas metas, se considerarmos que elas já não fazem mais sentido ou que as novas condições já não permitem o seu desenrolar.</p>
            <p>O caminho para alcançar tais mudanças passa por reflexão, realização de uma consulta íntima, procurando sempre manter o pensamento positivo, aliado a atitudes que elevem sua espiritualidade e o conduzam a autovalorização, sentimento próprio de quem deseja investir cada vez mais em sua realização e busca pela verdadeira felicidade. Se você se sente fragilizado e impotente para operacionalizar tais mudanças por si só, procure a ajuda de um profissional devidamente capacitado para realizar contigo essa jornada em busca de si mesmo e do sentido da sua existência.</p>
        </Principal>
        <Footer/>
        </>
    )
}
export default Filosofia_06