...
function Psicanalise_13 (){
    return (
        ...
        <Menu/>
        <Principal>
            <Titulo>A CEGUEIRA PROVOCADA PELO DESEJO DE NÃO ENXERGAR: VISÃO PSICANALÍTICA DA NEGAÇÃO:</Titulo>
            <p>A vivência de situações que nos provocam sentimentos de extrema vulnerabilidade, insegurança e incertezas como os que o momento de pandemia que atravessamos traz, tem como consequência possível o desenvolvimento de angústias e sofrimentos que podem se tornar insuportáveis para muitos, sobretudo em se tratando de eventos duradouros, cujo desfecho não conseguimos vislumbrar no horizonte. Em situações assim, é comum que muitas pessoas lancem mão de defesas psíquicas inconscientes, visando conseguir uma salvaguarda diante do sofrimento. Essas ações inconscientes são tratadas pela psicanálise como mecanismos de defesa.</p>
            <p>A psicanálise defende que todos nós desenvolvemos mecanismos de defesa em nosso inconsciente e o utilizamos diante da necessidade de nos proteger de alguma situação que consideramos ameaçadora. Quando nos sentimos ameaçados a colocamos em ação e, mesmo que temporariamente, temos nossas tensões psíquicas internas reduzidas. Um desses mecanismos é a negação.</p>
